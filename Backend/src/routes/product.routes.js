...
import { createProduct, getSeller, ShowAllProducts, getProductDetails, addProductVariant, updateProduct, deleteProduct } from "../controller/product.controller.js";
...
productRouter.delete("/:id", authenticateSeller, deleteProduct)
